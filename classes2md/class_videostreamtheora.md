...
:ref:`VideoStream<class_VideoStream>` resource handling the [Ogg Theora](https://www.theora.org/)_ video format with ``.ogv`` extension. The Theora codec is decoded on the CPU.
