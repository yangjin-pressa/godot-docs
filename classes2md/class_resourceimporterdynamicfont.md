...
- [Dynamic fonts - Using fonts](../tutorials/ui/gui_using_fonts.html#dynamic-fonts)_
...
If ``true``, forces generation of hinting data for the font using [FreeType](https://freetype.org/)_'s autohinter. This will make :ref:`hinting<class_ResourceImporterDynamicFont_property_hinting>` effective with fonts that don't include hinting data.
