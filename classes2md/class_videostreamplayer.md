...
Supported video formats are [Ogg Theora](https://www.theora.org/)_ (``.ogv``, :ref:`VideoStreamTheora<class_VideoStreamTheora>`) and any format exposed via a GDExtension plugin.
