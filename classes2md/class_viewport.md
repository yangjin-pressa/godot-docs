...
Use the [MetalFX spatial upscaler](https://developer.apple.com/documentation/metalfx/mtlfxspatialscaler#overview)_ for the viewport's 3D buffer.
...
More information: [MetalFX](https://developer.apple.com/documentation/metalfx)_.
...
Use the [MetalFX temporal upscaler](https://developer.apple.com/documentation/metalfx/mtlfxtemporalscaler#overview)_ for the viewport's 3D buffer.
