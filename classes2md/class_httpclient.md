...
For more information on HTTP, see [MDN's documentation on HTTP](https://developer.mozilla.org/en-US/docs/Web/HTTP)_ (or read [RFC 2616](https://tools.ietf.org/html/rfc2616)_ to get it straight from the source).
