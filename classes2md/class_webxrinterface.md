...
Possible values come from [WebXR's XRReferenceSpaceType](https://developer.mozilla.org/en-US/docs/Web/API/XRReferenceSpaceType)_, or include other features like ``"hand-tracking"`` to enable hand tracking.
