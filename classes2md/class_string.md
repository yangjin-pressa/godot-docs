...
Returns a single Unicode character from the decimal ``char``. You may use [unicodelookup.com](https://unicodelookup.com/)_ or [unicode.org](https://www.unicode.org/charts/)_ as points of reference.
...
Converts the string to a [UTF-8](https://en.wikipedia.org/wiki/UTF-8)_ encoded :ref:`PackedByteArray<class_PackedByteArray>`. This method is slightly slower than :ref:`to_ascii_buffer()<class_String_method_to_ascii_buffer>`, but supports all UTF-8 characters. For most cases, prefer using this method. This is the inverse of :ref:`PackedByteArray.get_string_from_utf8()<class_PackedByteArray_method_get_string_from_utf8>`.
